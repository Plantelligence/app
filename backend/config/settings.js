...
export const settings = {
  ...
  seedAdminEnabled: (process.env.SEED_ADMIN ?? '1') !== '0',
  defaultAdminEmail: process.env.DEFAULT_ADMIN_EMAIL ?? 'admin@plantelligence.local',
  defaultAdminPassword: process.env.DEFAULT_ADMIN_PASSWORD ?? 'Plant3ll!gence!',
  defaultAdminFullName: process.env.DEFAULT_ADMIN_FULLNAME ?? 'Demo Administrator',
  firebaseCredentials: (() => {
